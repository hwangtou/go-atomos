...
const (
	...
	HADoTestI_SyncRingCallDeadlock HADoTestI_TestMode = 4
	// Atom-测试调用外部后异步调用回自己不会死锁(hello1->hello2->hello1)
	HADoTestI_AsyncRingCallNoDeadlock HADoTestI_TestMode = 5
	...
	HADoTestI_ScaleSelfCallDeadlock HADoTestI_TestMode = 7
	// Scale-测试环形同步调用死锁(hello1->scale::element->hello1(deadlock)->hello1(deadlock))
	HADoTestI_ScaleRingCallDeadlockCase1 HADoTestI_TestMode = 8
	// Scale-测试环形同步调用死锁(hello1->scale::element->hello1(deadlock)->hello1(deadlock))
	HADoTestI_ScaleRingCallDeadlockCase2 HADoTestI_TestMode = 9
	// Wormhole
	// Wormhole-测试自我同步调用死锁(hello1->wormhole::hello1)
	HADoTestI_WormholeSelfCallDeadlock HADoTestI_TestMode = 10
	// Wormhole-测试环形同步调用死锁(hello1->wormhole::hello2->hello1)
	HADoTestI_WormholeRingCallDeadlock HADoTestI_TestMode = 11
	// Task
	// Task-测试自我同步调用死锁(hello1->task::hello1)
	HADoTestI_TaskSelfCallDeadlock HADoTestI_TestMode = 12
	// Task-测试环形同步调用死锁(hello1->task::hello1->hello2->hello1)
	HADoTestI_TaskRingCallDeadlock HADoTestI_TestMode = 13
	// Task-测试环形同步调用无死锁(hello1->task::hello1->hello2)
	HADoTestI_TaskRingCallNoDeadlock HADoTestI_TestMode = 14
	// Parallel
	// Parallel-测试自我同步调用无死锁(hello1->parallel::hello1)
	HADoTestI_ParallelSelfCallNoDeadlock HADoTestI_TestMode = 15
	// Parallel-测试环形同步调用无死锁(hello1->parallel::hello1->hello2->hello1)
	HADoTestI_ParallelRingCallDeadlock HADoTestI_TestMode = 16
	// Kill
	// Kill-测试自我同步调用死锁(hello1->hello1)
	HADoTestI_KillSelfCallDeadlock HADoTestI_TestMode = 17
	// Kill-测试环形同步调用死锁(hello1->hello2->hello1)
	HADoTestI_KillRingCallDeadlock HADoTestI_TestMode = 18
	// 远程启动Atom(a:hello1->b:b_hello1)
	HADoTestI_RemoteSpawnAtomAndHalt HADoTestI_TestMode = 19
	// Spawn-测试在Spawn的时候直接调用自己导致死锁(a:hello1->spawn::b:b_hello1->b:b_hello1)
	HADoTestI_RemoteSpawnSelfCallDeadlock HADoTestI_TestMode = 20
	// Spawn-测试在Spawn的时候调用外部后环形调用回自己导致死锁(a:hello1->spawn::b:b_hello1->a:hello2->b:b_hello1)
	HADoTestI_RemoteSpawnRingCallDeadlock HADoTestI_TestMode = 21
	// Remote Atom Sync and Async
	// Atom-测试在直接调用自己导致死锁(a:hello1->b:hello1->b:hello1)
	HADoTestI_RemoteSyncSelfCallDeadlock HADoTestI_TestMode = 22
	// Atom-测试调用外部后环形调用回自己导致死锁(a:hello1->b:hello1->a:hello2->b:hello1)
	HADoTestI_RemoteSyncRingCallDeadlock HADoTestI_TestMode = 23
	// Atom-测试调用外部后异步调用回自己不会死锁(a:hello1->b:hello1->a:hello1)
	HADoTestI_RemoteAsyncRingCallNoDeadlock HADoTestI_TestMode = 24
	// Atom-测试环形无返回异步调用无死锁无循环(a:hello1->b:hello1->a:hello1)
	HADoTestI_RemoteAsyncRingCallNoReplyNoDeadlock HADoTestI_TestMode = 25
	// Remote Scale
	// Scale-测试自我同步调用死锁(a:hello1->b:scale::element->b:element)
	HADoTestI_RemoteScaleSelfCallDeadlock HADoTestI_TestMode = 26
	// Scale-测试环形同步调用死锁(a:hello1->b:scale::element->a:hello1(deadlock)->a:hello1(deadlock))
	HADoTestI_RemoteScaleRingCallDeadlockCase1 HADoTestI_TestMode = 27
	// Scale-测试环形同步调用死锁(a:hello1->b:scale::element->a:hello1(deadlock)->a:hello1(deadlock))
	HADoTestI_RemoteScaleRingCallDeadlockCase2 HADoTestI_TestMode = 28 // TODO: 解决Sync回同节点却用了Remote的问题
	// 后续步骤
	HADoTestI_SpawnRingCallDeadlockStep2          HADoTestI_TestMode = 100
	...
	HADoTestI_TaskRingCallDeadlockStep2           HADoTestI_TestMode = 104
	HADoTestI_ParallelRingCallDeadlockStep2       HADoTestI_TestMode = 105
	HADoTestI_KillRingCallDeadlockStep2           HADoTestI_TestMode = 106
	// 远程调用后续步骤
	HADoTestI_RemoteSpawnRingCallDeadlockStep2          HADoTestI_TestMode = 107
	HADoTestI_RemoteSyncSelfCallDeadlockStep2           HADoTestI_TestMode = 108
	HADoTestI_RemoteSyncRingCallDeadlockStep2           HADoTestI_TestMode = 109
	HADoTestI_RemoteSyncRingCallDeadlockStep3           HADoTestI_TestMode = 110
	HADoTestI_RemoteAsyncRingCallNoDeadlockStep2        HADoTestI_TestMode = 111
	HADoTestI_RemoteAsyncRingCallNoReplyNoDeadlockStep2 HADoTestI_TestMode = 112
	HADoTestI_RemoteTaskRingCallDeadlockStep2           HADoTestI_TestMode = 113
	HADoTestI_RemoteParallelRingCallDeadlockStep2       HADoTestI_TestMode = 114
	HADoTestI_RemoteKillRingCallDeadlockStep2           HADoTestI_TestMode = 115
)
...
var (
	HADoTestI_TestMode_name = map[int32]string{
		...
		4:   "SyncRingCallDeadlock",
		5:   "AsyncRingCallNoDeadlock",
		6:   "AsyncRingCallNoReplyNoDeadlock",
		7:   "ScaleSelfCallDeadlock",
		8:   "ScaleRingCallDeadlockCase1",
		9:   "ScaleRingCallDeadlockCase2",
		10:  "WormholeSelfCallDeadlock",
		11:  "WormholeRingCallDeadlock",
		12:  "TaskSelfCallDeadlock",
		13:  "TaskRingCallDeadlock",
		14:  "TaskRingCallNoDeadlock",
		15:  "ParallelSelfCallNoDeadlock",
		16:  "ParallelRingCallDeadlock",
		17:  "KillSelfCallDeadlock",
		18:  "KillRingCallDeadlock",
		19:  "RemoteSpawnAtomAndHalt",
		20:  "RemoteSpawnSelfCallDeadlock",
		21:  "RemoteSpawnRingCallDeadlock",
		22:  "RemoteSyncSelfCallDeadlock",
		23:  "RemoteSyncRingCallDeadlock",
		24:  "RemoteAsyncRingCallNoDeadlock",
		25:  "RemoteAsyncRingCallNoReplyNoDeadlock",
		26:  "RemoteScaleSelfCallDeadlock",
		27:  "RemoteScaleRingCallDeadlockCase1",
		28:  "RemoteScaleRingCallDeadlockCase2",
		100: "SpawnRingCallDeadlockStep2",
		101: "SyncRingCallDeadlockStep2",
		102: "AsyncRingCallNoDeadlockStep2",
		103: "AsyncRingCallNoReplyNoDeadlockStep2",
		104: "TaskRingCallDeadlockStep2",
		105: "ParallelRingCallDeadlockStep2",
		106: "KillRingCallDeadlockStep2",
		107: "RemoteSpawnRingCallDeadlockStep2",
		108: "RemoteSyncSelfCallDeadlockStep2",
		109: "RemoteSyncRingCallDeadlockStep2",
		110: "RemoteSyncRingCallDeadlockStep3",
		111: "RemoteAsyncRingCallNoDeadlockStep2",
		112: "RemoteAsyncRingCallNoReplyNoDeadlockStep2",
		113: "RemoteTaskRingCallDeadlockStep2",
		114: "RemoteParallelRingCallDeadlockStep2",
		115: "RemoteKillRingCallDeadlockStep2",
	}
	HADoTestI_TestMode_value = map[string]int32{
		...
		"RemoteScaleRingCallDeadlockCase2":          28,
...
var file_examples_hello_atomos_api_hello_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xf5, 0x0b,
	...
	0x64, 0x65, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x22, 0xba, 0x0b, 0x0a, 0x08, 0x54, 0x65, 0x73,
	...
	,
	...
	,
