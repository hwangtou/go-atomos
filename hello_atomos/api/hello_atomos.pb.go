...
func (c *HelloAtomosElementID) ScaleBonjour(callerID go_atomos.SelfID, in *HABonjourI, ext ...interface{}) (out *HABonjourO, err *go_atomos.Error) {
	...
	defer id.Release()
	return helloAtomosAtomMessengerValue.ScaleBonjour().SyncAtom(id, callerID, in, ext...)
}
...
func (c *HelloAtomosElementID) ScaleDoTest(callerID go_atomos.SelfID, in *HADoTestI, ext ...interface{}) (out *HADoTestO, err *go_atomos.Error) {
	...
	defer id.Release()
	return helloAtomosAtomMessengerValue.ScaleDoTest().SyncAtom(id, callerID, in, ext...)
}
