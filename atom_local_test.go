...
//
//func testSpawnAtom(t *testing.T, elem *ElementLocal, name string, arg proto.Message, skip int) (*AtomLocal, *IDTracker, *Error) {
//	atom, tracker, err := elem.SpawnAtom(name, arg, skip+1)
//	if err != nil {
//		t.Errorf("testSpawnAtom: Failed. state=(%v),err=(%v)", atom.atomos.GetState(), err)
//		return nil, nil, err
//	}
...
//
//	atom, tracker, err := testSpawnAtom(t, elem, testAtomName, nil, 1)
//	if err != nil {
//		t.Errorf("TestAtomLocal: Failed. err=(%v)", err)
//	}
//	t.Logf("Atom=(%v)\nTracker=(%v)", atom, tracker)
//
//	//// Push Message.
