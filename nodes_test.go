...
//	if c1cr2e.State() != BaseAtomosWaiting {
//		t.Fatal("id state is not BaseAtomosWaiting")
//	}
//	// Get Atom ID State
//	if id3.State() != BaseAtomosWaiting {
//		t.Fatal("id state is not BaseAtomosWaiting")
//	}
//
...
//		//} else if a.idTrackerManager.refCount() != 1 {
//		//	t.Fatal("refCount is not 1")
//	} else if a.State() != BaseAtomosWaiting {
//		t.Fatal("atom state is not BaseAtomosHalt")
...
//	process, err := newCosmosProcess(cosmosName, cosmosNode, newTestLogging(t))
//	if err != nil {
//		t.Fatal(err)
//	}
