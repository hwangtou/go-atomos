...
func (c *atomosRemoteServiceClient) AsyncMessagingByName(ctx context.Context, in *CosmosRemoteAsyncMessagingByNameReq, opts ...grpc.CallOption) (*CosmosRemoteAsyncMessagingByNameRsp, error) {
	...
	err := c.cc.Invoke(ctx, AtomosRemoteService_AsyncMessagingByName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *atomosRemoteServiceClient) AsyncOnMessageCallback(ctx context.Context, in *CosmosRemoteAsyncOnMessageCallbackReq, opts ...grpc.CallOption) (*CosmosRemoteAsyncOnMessageCallbackRsp, error) {
	...
	err := c.cc.Invoke(ctx, AtomosRemoteService_AsyncOnMessageCallback_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
