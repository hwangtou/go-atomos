...
//
//	// Check Spawn state.
//	if err := checkElementLocalInElement(t, process, elemName, BaseAtomosWaiting); err != nil {
...
//	if err = checkElementLocalInElement(t, process, elemName, BaseAtomosBusy); err != nil {
...
//		return
//	}
//	if err = atom.atomos.PushKillMail(testElem, true, 0); err != nil {
//		t.Errorf("TestAtomLocalBase: Kill failed. err=(%v)", err)
//		return
//	}
//	//atom.Release(tracker)
//	tracker.Release()
//	if err = checkAtomLocalInElement(t, testElem, testAtomName, true, BaseAtomosHalt, 0); err != nil {
...
//			return
//		}
//		if err := checkElementLocalInElement(t, process, elemName, BaseAtomosHalt); err != nil {
//			t.Errorf("TestElementLocal_SpawnConditions: State invalid. err=(%v)", err)
//			return
//		}
//		w := 32
...
//	}
//	atom := a.(*AtomLocal)
//	if err = checkAtomLocalInElement(t, testElem, testAtomName, false, BaseAtomosWaiting, 1); err != nil {
...
//		return
//	}
//	if err = checkAtomLocalInElement(t, testElem, testAtomName, false, BaseAtomosWaiting, 2); err != nil {
//		t.Errorf("TestAtomLocalBase: Get ScaleID failed. err=(%v)", err)
//		return
//	}
//	if scaleID != atom {
...
//}
//
//func checkElementLocalInElement(t *testing.T, process *CosmosProcess, name string, isState BaseAtomosState) *Error {
